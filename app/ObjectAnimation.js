    ...
    const steps = [
        {
            ...
            content: 'Class là một bản thiết kế cho đối tượng. Nó định nghĩa các thuộc tính và phương thức mà đối tượng sẽ có.'
        },
        {
            title: 'Tạo Object',
            content: 'Object là một thể hiện cụ thể của class. Nó được tạo ra dựa trên bản thiết kế của class.'
        },
        {
            title: 'Truy cập thuộc tính',
            content: 'Chúng ta có thể truy cập và thay đổi các thuộc tính của object.'
        },
        {
            title: 'Gọi phương thức',
            content: 'Chúng ta có thể gọi các phương thức được định nghĩa trong class thông qua object.'
        }
    ];
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>
                    {lessonData ? lessonData.name : 'Lập trình hướng đối tượng: Class và Object'}
                </Text>
            ...
            <Text style={styles.title}>Lập trình hướng đối tượng: Class và Object</Text>
            ...
            <View style={styles.animationContainer}>
                ...
                <Animated.View style={[styles.objectBox, objectAnimatedStyle]}>
                    ...
                    <View style={styles.classDivider} />
                    <Animated.Text style={[styles.classContent, propertyAnimatedStyle]}>color: 'đỏ'</Animated.Text>
                    <Animated.Text style={[styles.classContent, methodAnimatedStyle]}>start()</Animated.Text>
                </Animated.View>
            </View>
