...
export default AbstractionAnimation = () => {
    ...
    const concreteClassStyle = useAnimatedStyle(() => ({
        ...
        transform: [{ translateY: withSpring((1 - concreteClassOpacity.value) * 50) }],
    }));
    ...
    const steps = [
        {
            ...
            content: 'Định nghĩa một giao diện chung cho một nhóm các đối tượng liên quan.'
        },
        {
            title: 'Lớp cụ thể',
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>
                    {lessonData ? lessonData.name : 'Tính trừu tượng trong OOP'}
                </Text>
            ...
            <View style={styles.animationContainer}>
                <Animated.View style={[styles.classBox, abstractClassStyle]}>
                    ...
                    <Text style={styles.classContent}>+ abstract getArea(): number</Text>
                    <Text style={styles.classContent}>+ abstract getPerimeter(): number</Text>
                </Animated.View>
                ...
                <Animated.View style={[styles.classBox, concreteClassStyle]}>
                    ...
                    <View style={styles.classDivider} />
                    <Animated.Text style={[styles.classContent, implementationStyle]}>+ getArea(): number</Animated.Text>
                    <Animated.Text style={[styles.classContent, implementationStyle]}>+ getPerimeter(): number</Animated.Text>
                </Animated.View>

                <Animated.View style={[styles.usageBox, usageStyle]}>
                    <Text style={styles.usageContent}>Shape shape = new Circle(5);</Text>
                    <Text style={styles.usageContent}>double area = shape.getArea();</Text>
                </Animated.View>
            </View>
