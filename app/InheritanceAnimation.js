...
const InheritanceAnimation = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      content:
        "Lớp con có thể định nghĩa lại (override) các phương thức của lớp cha.",
    },
  ];
    ...
    <View style={[styles.container, { marginTop }]}>
      ...
      <View style={{ flex: 1, padding: 20 }}>
        <View style={styles.diagramContainer}>
          ...
          <Animated.View
            style={[styles.inheritanceLine, inheritanceLineStyle]}
          />
          ...
          <Animated.View style={[styles.classBox, childClassStyle]}>
            ...
            <View style={styles.classDivider} />
            <Animated.Text
              style={[styles.classContent, inheritedPropertiesStyle]}
            >
              + brand: string
            </Animated.Text>
            <Animated.Text style={[styles.classContent, ownPropertiesStyle]}>
              + model: string
            </Animated.Text>
            <View style={styles.classDivider} />
            <Animated.Text style={[styles.classContent, overriddenMethodStyle]}>
              + start(): void
            </Animated.Text>
          </Animated.View>
        </View>
